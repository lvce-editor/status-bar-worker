...
export const test: Test = async ({ Command, Editor, expect, FileSystem, Locator, Main, StatusBar: { click: clickStatusBarItem }, Workspace }) => {
  ...
  await clickStatusBarItem('EditorPosition')
  ...
  await clickStatusBarItem('EditorIndentation')
  ...
  await clickStatusBarItem('EditorEndOfLine')
  ...
  await clickStatusBarItem('EditorLanguage')
