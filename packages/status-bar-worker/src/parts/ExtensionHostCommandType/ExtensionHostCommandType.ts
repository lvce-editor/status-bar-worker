...
export const FormattingExecuteFormattingProvider = 'ExtensionHostFormatting.executeFormattingProvider'
export const GetStatusBarItems = 'ExtensionHost.getStatusBarItems2'
